...
export const AmazonReviewEmail = ({
  ...
  reviwStars = Array(5).fill(`https://react-email-demo-fporhyhl7-resend.vercel.app/static/amazon-rating.gif`),
  socialMediaIcons = [
    `https://react-email-demo-fporhyhl7-resend.vercel.app/static/amazon-instagram.jpg`,
    `https://react-email-demo-fporhyhl7-resend.vercel.app/static/amazon-facebook.jpg`,
    `https://react-email-demo-fporhyhl7-resend.vercel.app/static/amazon-twitter.jpg`,
  ],
        ...
        <Container style={container}>
            ...
            <Row>
              <Column align="center">
                <Link href="https://www.amazon.com">
                  <Img
                    src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/amazon-prime-logo.png`}
                    width="109"
                    height="48"
          ...
          <Section>
            <Row>
              <Column>
                <Img
                  src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/amazon-book.jpg`}
                  alt="Amazon Book"
                  width="274"
                  height="350"
                />
          ...
          <Section>
            <Row>
              <Column>
                <Img
                  src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/amazon-logo.png`}
                  alt="Amazon Logo"
                  width="93"
                  height="23"
                />
