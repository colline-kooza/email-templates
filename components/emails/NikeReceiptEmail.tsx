    ...
    <Body style={main}>
      ...
      <Container style={container}>
        ...
        <Section style={message}>
          <Img
            src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/nike-logo.png`}
            width="66"
            height="22"
            alt="Nike"
            style={{ margin: 'auto' }}
        ...
        >
          <Row>
            <Column>
              <Img
                src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/nike-product.png`}
        ...
        <Section style={paddingY}>
          ...
          <Row style={recomendations.container}>
            ...
            >
              <Img
                src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/nike-recomendation-1.png`}
                alt="Brazil 2022/23 Stadium Away Women's Nike Dri-FIT Soccer Jersey"
                width="100%"
              />
            ...
            <Column style={recomendations.product} align="center">
              <Img
                src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/nike-recomendation-2.png`}
                alt="Brazil 2022/23 Stadium Away Women's Nike Dri-FIT Soccer Jersey"
                width="100%"
              />
              <Text style={recomendations.title}>
            ...
            <Column style={recomendations.product} align="center">
              <Img
                src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/nike-recomendation-4.png`}
                alt="Brazil 2022/23 Stadium Away Women's Nike Dri-FIT Soccer Jersey"
                width="100%"
              />
            ...
            <Column>
              <Row>
                <Column style={{ width: '16px' }}>
                  <Img
                    src={`https://react-email-demo-fporhyhl7-resend.vercel.app/static/nike-phone.png`}
                    alt="Nike Phone"
                    width="16px"
                    height="26px"
